/**
 * Created by Dealing076 on 2018/4/2.
 */
//@ sourceURL=bondmanagerlist.js
$(function () {
...
function editBondMan(obj) {
    ...
    var bondCode = $(objTR).find(".linkman-bond-code").text();
    ...
    $.ajax(contextPath + "/companylinkman/bondman").success(function (data) {
        console.log("success");
...
function viewBondMan(obj) {
    var index = $(obj).parent().parent().parent().index();  //当前行索引
    var objTR = $("#tabInfoLinkBond tr:eq(" + index + ")");
    var bondCode = $(objTR).find("div[name='linkmanBondCode']").text();
