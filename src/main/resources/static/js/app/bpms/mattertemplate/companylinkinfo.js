...
function loadTemplateInfo(){
    $.ajax({
        type: 'GET',
        url: contextPath + "/mattertemplate/companylink/" + $("#hidCompanyTemplateId").val(),
        cache: false,
...
function loadHistoryInfo(){
    $.ajax({
        type: 'GET',
        url: contextPath + "/mattertemplate/companylinkhistory/" + $("#hidCompanyTemplateId").val(),
        cache: false,
        success: function (data) {
            console.log("success");
            $("#divInfoHistory").html("");
