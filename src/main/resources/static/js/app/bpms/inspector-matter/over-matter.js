...
function initTable() {
        ...
        $.ajax({
            url: contextPath + "/inspector-matter/findOverMatters",
            type:"post",
...
function  viewOverMatter(id) {
    $.ajax(contextPath + "inspector-matter/view-over-matter/" + id).success(function (data) {
        console.log("success");
        pageTask = layer.open({
            type: 1,
            title: id,
...
function  viewOverRightLineMatter(id) {
    $.ajax(contextPath + "inspector-matter/view-over-matter/right-line/" + id).success(function (data) {
        console.log("success");
        pageTask = layer.open({
            type: 1,
            title: id,
