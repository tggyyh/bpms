        ...
        var c = {
            ...
            o = function () {
                this.update = function (b, c) {
                    ...
                    var fn = {"SimSun":"宋体","SimHei":"黑体","KaiTi":"楷体","NSimSun":"新宋体","FangSong":"仿宋","Serif":"Serif", "Sans":"Sans", "Arial":"Arial", "Arial Black":"Arial Black", "Courier":"Courier", "Courier New":"Courier New", "Comic Sans MS":"Comic Sans MS", "Helvetica":"Helvetica", "Impact":"Impact", "Lucida Grande":"Lucida Grande", "Lucida Sans":"Lucida Sans", "Tahoma":"Tahoma", "Times":"Times", "Times New Roman":"Times New Roman", "Verdana":"Verdana"};
                    if (g.length > 0) {
                        var h = c["font-family"];
                        h && (h = e.head(h.split(",")), h = h.replace(/\'/g, ""), g.find(".note-current-fontname").text(fn[h]), d(g, h))
                    }
            ...
            t = function () {
                ...
                b = {
                    ...
                    fontname: function (a) {
                        var b = ["SimSum", "SimHei", "KaiTi", "NSimSun", "FangSong", "Serif", "Sans", "Arial", "Arial Black", "Courier", "Courier New", "Comic Sans MS", "Helvetica", "Impact", "Lucida Grande", "Lucida Sans", "Tahoma", "Times", "Times New Roman", "Verdana"];
                        var bn = ["宋体", "黑体", "楷体", "新宋体", "仿宋", "Serif", "Sans", "Arial", "Arial Black", "Courier", "Courier New", "Comic Sans MS", "Helvetica", "Impact", "Lucida Grande", "Lucida Sans", "Tahoma", "Times", "Times New Roman", "Verdana"];
                        c = '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="' + a.font.name + '" tabindex="-1"><span class="note-current-fontname">宋体</span> <b class="caret"></b></button>';
                        c += '<ul class="dropdown-menu">';
                        for (var d = 0; d < b.length; d++) c += '<li><a data-event="fontName" data-value="' + b[d] + '"><i class="fa fa-check icon-ok"></i>' + bn[d] + '</a></li>';
                        return c += "</ul>"
                    },
                    fontsize: function (a) {
